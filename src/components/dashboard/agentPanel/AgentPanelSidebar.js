      ...
      <div className='sidebar-user sticky-cls'>
        <div className='user-profile'>
          <div className='media'>
            <div className='change-pic'>
              <Image src='/assets/images/avatar/3.jpg' className='img-fluid update_img' alt='' />
        ...
        <div className='dashboard-list'>
          <Nav tabs className='right-line-tab'>
            ...
            <NavItem>
              <NavLink className={activeTab === "Wishlist" ? "active" : ""} onClick={() => setActiveTab("Favorites")}>
                Wishlist
              </NavLink>
            </NavItem>
            <NavItem>
            ...
            <NavItem>
              <NavLink
                className={activeTab === "PrivacyTab" ? "active" : ""}
